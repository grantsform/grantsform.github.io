...
const data = {
  nodes: [
    // central anchor remains visible but without text label
    { key: 'center', attributes: { label: '', x: 0, y: 0, size: 20, color: '#2196f3', description: 'Core interests and passions that drive my work and exploration.', links: [] } },
