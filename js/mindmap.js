...
const data = {
  nodes: [
    { key: 'center', attributes: { label: 'What Excites Me', x: 0, y: 0, size: 20, color: '#2196f3', description: 'Core interests and passions that drive my work and exploration.', links: [] } },
